 ...
 * 文物临时进境查验列表查询
 */
export function queryApplyDList(data) {
  return request({
    url: API_PREFIX.APPRAISAL + '/culturalRelicsAppraisal/queryApplyDList',
    method: 'post',
    data
  })
}
 ...
 * 临时进境展览事项详情查询
 */
export function getApplyDeDetail(data) {
  return request({
    url: API_PREFIX.PERSONAL + '/bizCroItem/getApplyDeDetail',
    method: 'post',
    data
  })
}
