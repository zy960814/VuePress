...
<script>
  ...
  import CulturalProtectionUnit from './CulturalProtectionUnit'
  import CollectionPreciousCr from './CollectionPreciousCr'
  ...
  export default {
    ...
    methods: {
      ...
      handleSelect(index) {
        this.$router.push(`/national/statistical-analysis/cr-noumenon?tab=${index}`);
      }
    }
  }
</script>
