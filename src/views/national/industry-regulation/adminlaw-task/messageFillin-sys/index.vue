        ...
        <el-card shadow="never">
          ...
          <el-scrollbar :style="{height: dialogContentHeight}">
            <el-table :data="tableData" border style="width: 100%;">
              ...
              <el-table-column prop="name" label="字段名" min-width="50"></el-table-column>
            ...
            <el-form-item style="margin-top: 0px;margin-bottom:0px;">
              <div class="clear-float">
                <div class="fl" style="margin-bottom:3px;">
                  <el-button type="primary" @click="addPerson" icon="el-icon-circle-plus-outline">添加</el-button>
                </div>
            ...
            <el-row :gutter="20">
              <el-col :span="24">
                <el-form-item label="检查行为名称" prop="checkActionName" class="redStar">
                  <el-input
                    v-model="personInfo.checkActionName"
            ...
            <el-row :gutter="20">
              <el-col :span="24">
                <el-form-item label="检查行为编号" prop="checkActionCode" class="redStar">
                  <el-input v-model="personInfo.checkActionCode" placeholder="系统自动生成，无需填写" disabled></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="检查类别" class="redStar" prop="checkType">
                  <el-input v-model="personInfo.checkType" disabled></el-input>
                  <!-- <el-select
                          v-model="personInfo.item.checkType"
                          placeholder="请选择检查类别"
                          style="width: 100%"
                          disabled
                        >
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="检查方式">
                  ...
                  <!-- <el-input v-model="personInfo.checkMode"></el-input> -->
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="检查时间" prop="checkDate" class="redStar">
                  <el-date-picker
                    v-model="personInfo.checkDate"
                    type="date"
                    placeholder="选择日期"
            ...
            <el-row :gutter="20">
              <el-col :span="24">
                <el-form-item label="检查结果" prop="checkResult">
                  <el-select
                    v-model="personInfo.checkResult"
                    placeholder="请选择检查结果"
                    style="width: 100%"
                  >
                    <el-option
...
export default {
  components: { MyDialog, VerticalTable, ApplyFormItem },
  data() {
    return {
      pickerOptions: {
        // disabledDate(time) {
  ...
  computed: {
    ...
    // dialogHeight2() {
    //   return this.$store.getters.screenHeight > 380
    //     ? 380
    //     : this.$store.getters.screenHeight
    // },
  ...
  methods: {
    ...
    waitHandledetail() {
      ...
      waitDetail(this.currentCrId).then(responseData => {
        ...
        console.log('查询详情')
        // TODO:解决：由于表格中下拉框校验必须用scope.row.checkResult，导致下拉框一进页面渲染比表格快所以不能根据code选中对应的name
        // this.personInfo.checkItemList.forEach(itemOuter => {
        //   itemOuter.checkResult = itemOuter.checkResultName
        // })
        console.log(this.personInfo)
    ...
    // 保存TODO:问一下后端需不需要01，02的都传给他
    saveTask() {
      // 检查形式
      this.addName(
        this.checkFormArr,
        this.personInfo.checkForm,
        'checkFormName'
      )
      // 检查方式
      this.addName(
        this.checkModeArr,
        this.personInfo.checkMode,
        'checkModeName'
      )
      // 检查结果
      this.addName(
        this.checkResultArr,
        this.personInfo.checkResult,
        'checkResultName'
      )
      // 结果
    ...
    subJgJgxwCheckAction() {
      ...
      //   this.personInfo.administrativeCpNa,
      //   'administrativeCpNaName'
      // )
      // // 行政相对人证件类型
      // this.addName(
      //   this.administrativeCpCeTypeArr,
      //   this.personInfo.administrativeCpCeType,
    ...
    addName(arr, code, name) {
      ...
      this.personInfo[name] = item.name
    },
