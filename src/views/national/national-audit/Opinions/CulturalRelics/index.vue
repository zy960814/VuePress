      ...
      :show-message="false">
        ...
        <el-col :span="24">
          <el-form-item label="意见" prop="opinionContent" class="redStar">
            <el-input
              type="textarea"
              v-model="allData.CulturalRelics.form.opinionContent"
              :autosize="{ minRows: 5}">
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="是否通过">
            <el-radio-group v-model="allData.CulturalRelics.form.isIllegal">
        ...
        <el-col :span="24">
          <el-form-item ref="fileUpload" label="附件" prop="technologyDocument" >
            <el-upload
              ...
              :file-list="allData.CulturalRelics.form.technologyDocument"
              :multiple="false"
              :limit="1"
        ...
        <el-col :span="24">
          <el-form-item label="备注" prop="remark">
              <el-input 
                :autosize="{ minRows: 3}"
                type="textarea"
                v-model="allData.CulturalRelics.form.remark"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
		</el-form>
