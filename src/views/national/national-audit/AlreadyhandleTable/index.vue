  ...
  data() {
    return {
      ...
      applyStateOption: [
        ...
        { qualRangeName: "古迹遗址协会退回", qualRangeCode: "other_deal_update"}
      ],
      checkColInit: [
        {
          label: '序号',
      ...
      // waitHandleTable: [],
       waitHandleTable: [
        {
          corp_name: "宋高华",
          create_time: "2020-05-26 15:43:51",
          inst_name: "龙泉观松古建筑工程有限公司",
          perNum: null,
          qualRangeName: "古文化遗址古墓葬,古建筑,近现代重要史迹及代表性建筑",
          qualificationLevel: "施工三级",
        }
      ],
