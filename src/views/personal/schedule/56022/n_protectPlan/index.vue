<template>
  <div class="content">
    <el-card class="box-card" shadow="never">
      <div slot="header">全国重点文物保护单位保护规划申请</div>
...
import ConfirmMessage from '@/components/business/ConfirmMessage56022/n_protectPlan'
...
export default {
  ...
  methods: {
    ...
    saveOrSubmit(type) {
      ...
      //     type
      //   ),
      //   this.$refs.projectInformation.$refs.projectSituation.getFormData(type),
      //   this.$refs.projectInformation.$refs.reportFact.getFormData(type),
      //   this.$refs.projectInformation.$refs.designFact.getFormData(type),
