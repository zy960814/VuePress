<template>
  <div class="content">
    <el-card class="box-card" shadow="never">
      <div slot="header">全国重点文物保护单位修缮审批申请</div>
        ...
        <template #body>
          ...
          <div class="scrollBox" :style="{height: contentHeight}">
            <basic-information
              ...
              id="basicInformation"
            ></basic-information>
            <immediately-replay class="hxl_item" ref="immediatelyReplay" id="immediatelyReplay"></immediately-replay>
            <project-information
              class="hxl_item"
              ref="projectInformation"
              id="projectInformation"
              applyType="n_approvalplan"
            ></project-information>
            <apply-material
              class="hxl_item"
              ref="applyMaterial"
...
// import ImmediatelyReplay from './ImmediatelyReplay'
// import ApplyMaterial from './ApplyMaterial'
// import ConfirmMessage from './ConfirmMessage'
import ProjectInformation from '@/components/business/ProjectInformation_14_one'
import ImmediatelyReplay from '@/components/business/ImmediatelyReplay_14_one'
import ApplyMaterial from '@/components/business/ApplyMaterial_14_one'
import ConfirmMessage from '@/components/business/ConfirmMessage56014/n_approvalplan'
...
export default {
  ...
  data() {
    return {
      dialogVisible: false,
      // 切换按钮标题
      titleData: ['基本信息', '立项批复文件', '工程设计方案信息', '申请材料'],
      applyFormData: {},
      menuKey: 1
    }
  },
    ...
    saveOrSubmit(type) {
      ...
      if (this.$refs.projectInformation.$refs.basicMessage.$refs.designDialog) {
        Promise.all([
          ...
          this.$refs.projectInformation.$refs.reportFact.getFormData(type),
          this.$refs.projectInformation.$refs.designFact.getFormData(type),
