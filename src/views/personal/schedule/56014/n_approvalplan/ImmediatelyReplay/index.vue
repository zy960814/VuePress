...
export default {
  ...
  methods: {
    ...
    //   console.log(this.$refs.replayDocument.$refs.selfDocument)
    //   if (this.$refs.replayDocument.$refs.selfDocument) {
    //     this.form.replayDocumentTitle = this.$refs.replayDocument.$refs.selfDocument.form.replayDocumentTitle
    //     this.form.replayDocumentNo = this.$refs.replayDocument.$refs.selfDocument.form.replayDocumentNo
    //     this.form.approvalResponse = this.$refs.replayDocument.$refs.selfDocument.form.approvalResponse[0]
