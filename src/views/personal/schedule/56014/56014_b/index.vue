  ...
  <div class="content">
    ...
    >
      <el-card shadow="never">
        <div slot="header">全国重点文物保护单位安全防护工程设计方案申请</div>
...
import ProjectInformation from '@/components/business/ProjectInformation_14_two'
import ApplyMaterial from '@/components/business/ApplyMaterial_14_two'
import ConfirmMessage from '@/components/business/ConfirmMessage56014/n_reportCRB'
    ...
    saveOrSubmit(type) {
      ...
      if (this.$refs.projectInformation.$refs.basicMessage.$refs.designDialog) {
        Promise.all([
          ...
          form.companyLocation = `${form.companyLocation_part1}${form.companyLocation_part2}${form.companyLocation_part3}`
          // form.fundsSource = `${form.fundsSource_part1}${form.fundsSource_part2}`
          ...
          // delete this.applyFormData['companyLocation_part1']
          // delete this.applyFormData['companyLocation_part2']
          // delete this.applyFormData['companyLocation_part3']
