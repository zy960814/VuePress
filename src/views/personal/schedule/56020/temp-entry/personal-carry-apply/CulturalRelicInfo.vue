  ...
  <apply-form-item class="cr-info" data="文物或复仿制品信息">
    <div style="padding: 0 18px">
      ...
      <el-table ref="table" :data="tableData" border>
        ...
        <el-table-column label="文物或复仿制品名称" width="180">
          <template slot-scope="scope">
            <el-link
                :underline="false"
                type="primary"
                @click="openViewDialog(scope.row, 'view')"
            >{{ scope.row.crName }}
            </el-link>
          </template>
        </el-table-column>
        ...
        <el-table-column label="照片"></el-table-column>
  ...
  export default {
    ...
    computed: {
      ...
      dialogHeight: function () {
        return this.$store.getters.screenHeight > 904
          ? 904
