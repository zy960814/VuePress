<template>
  <apply-form-item data="基本信息">
    ...
    >
      <el-row class="spilt">
        <el-col :span="24">
          <el-form-item label="申请事项名称" prop="itemName" class="redStar">
            <el-input v-model="form.itemName" placeholder="建议包含便于查询检索的关键信息"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row style="margin-top: 18px">
        ...
        <el-col :span="11" :offset="2">
          <el-form-item label="国籍" prop="nationalityCode" class="redStar">
            <el-select v-model="form.nationalityCode" filterable placeholder value>
              <el-option
      ...
      <el-row>
        <el-col :span="11">
          <el-form-item label="证件类型" prop="certificateTypeCode" class="redStar">
            <el-select v-model="form.certificateTypeCode" placeholder value>
              <el-option
      ...
      <el-row>
        <el-col :span="11">
          <el-form-item label="出境海关" prop="customsOut" class="redStar">
            <el-input v-model="form.customsOut"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11" :offset="2">
          <el-form-item label="出境时间" prop="exitTime" class="redStar">
            <el-date-picker
      ...
      <el-row>
        <el-col :span="11">
          <el-form-item label="审核机构" prop="appraisalId" class="redStar" style="margin-bottom: 0px;">
    ...
    return {
      ...
      rules: {
        ...
        save: {
          ...
          certificateNum: [
            { max: 40, message: '长度最大 40 个字符', trigger: 'blur' },
          ...
          customsOut: [{ max: 30, message: '长度最大 30 个字符', trigger: 'blur' }]
        },
        submit: {
          itemName: [
          ...
          exitTime: [{ required: true, message: ' ', trigger: 'change' }],
        ...
        this.$nextTick(() => {
          this.$refs['form'].validate(valid => {
            if (valid) {
              ...
              this.form.certificateTypeName = certificate
                ? certificate.name
                : ''
              // 审核机构字典项处理
