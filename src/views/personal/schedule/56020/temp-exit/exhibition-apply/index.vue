<template>
  <el-card class="box-card" shadow="never">
    <div slot="header">文物临时出境展览申请</div>
    <apply-form :data="titleData" @tab-click="itemClick">
      ...
      <template #body>
        <div class="scrollBox" :style="{height: contentHeight}">
          <basic-info ref="basicInfo" class="hxl_item" applyType="temp-exit" />
...
import {
  ...
  listCulturalRelic
} from '@/api/personal/schedule/56020/temp-exit'
