<template>
  <apply-form-item data="展览信息">
    ...
    >
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="展品来源地" prop="relicsOrigin" class="redStar">
            <el-input v-model="form.relicsOrigin" placeholder="请填写具体地址（城市、街道...）"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="11">
          <el-form-item label="备案文号" prop="recordNumber" class="redStar">
            <el-input v-model="form.recordNumber" placeholder="请填写此次展览的批准文件的文号"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          ...
          >
            <el-upload
                ...
                :data="{fieldCode: 'BAWJ', fieldName: '备案文件'}"
      ...
      return {
        ...
        rules: {
          ...
          submit: {
            ...
            docType: [
              {required: true, message: '请上传备案文件', trigger: 'blur'}
            ]
          }
        }
      }
