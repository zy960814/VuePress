<template>
  <apply-form-item data="展览信息">
    ...
    >
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="出境目的地">
            <el-input v-model="form.destination" :disabled="formDisabled"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="11">
          <el-form-item label="批准文号">
            <el-input v-model="form.dispatchFileNum" :disabled="formDisabled"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item ref="fileUpload" label="批准文件" style="margin-bottom: 0">
            <el-upload
                action
...
<script>
  ...
  import {saveAgainEexhibitionAll} from '@/api/personal/schedule/56020/repeat-entry'
