<template>
  <el-card class="box-card" shadow="never">
    <div slot="header">展览文物临时出境复进境申请</div>
...
<script>
  ...
  import {saveApplyEexhibition, submitExhibitionInfo} from '@/api/personal/schedule/56020/repeat-entry'
