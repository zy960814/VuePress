...
<script>
  ...
  import {findSelectableDExhibitionList} from '@/api/personal/schedule/56020/repeat-entry'
  ...
  export default {
    ...
    methods: {
      ...
      search(currentPage) {
        ...
        findSelectableDExhibitionList(this.queryParams).then(({data}) => {
      ...
      getData() {
        return new Promise((resolve, reject) => {
          if (this.currentItem) {
            ...
            this.$store.dispatch('promptWarningMsg', '请选择文物临时出境展览');
            reject()
          }
        })
      }
