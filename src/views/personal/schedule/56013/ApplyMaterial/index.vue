    ...
    >
      <el-row>
        <el-col :span="24">
          <el-form-item
            ...
            label="出境文物及自然标本清单"
            prop="cjwwjzrbbqd"
            class="normal redStar"
          >
            <el-upload
              :action="fileUploadUrl"
              :on-preview="handlePreview"
              :on-remove="(file,fileList)=>{return handleRemove (file,fileList,'cjwwjzrbbqd')}"
              :data="{fieldCode: 'BAWJ', fieldName: '出境文物及自然标本清单'}"
              :file-list="form.cjwwjzrbbqd"
              :multiple="false"
              :limit="1"
              :before-upload="beforeUpload"
              :on-success="(file,fileList)=>{return fileUploadSuccess (file,fileList,'cjwwjzrbbqd')}"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item
            ref="fileUpload"
            label="合作考古调查、勘探、发掘或研究项目的批准文件"
            prop="hzkgdcktfjhyjxmdpzwj"
            class="normal redStar"
          >
            <el-upload
              :action="fileUploadUrl"
              ...
              :data="{fieldCode: 'BAWJ', fieldName: '合作考古调查、勘探、发掘或研究项目的批准文件'}"
              :file-list="form.hzkgdcktfjhyjxmdpzwj"
              :multiple="false"
              :limit="1"
              :before-upload="beforeUpload"
              :on-remove="(file,fileList)=>{return handleRemove (file,fileList,'hzkgdcktfjhyjxmdpzwj')}"
              :on-success="(file,fileList)=>{return fileUploadSuccess (file,fileList,'hzkgdcktfjhyjxmdpzwj')}"
              :on-error="fileUploadError"
            >
              <el-button size="small" type="primary">点击上传</el-button>
              <span slot="tip" class="el-upload__tip" style="font-size:12px">支持扩展名：doc / docx / pdf</span>
        ...
        <el-col :span="24">
          ...
          >
            <el-upload
              ...
              :on-preview="handlePreview"
              :before-remove="beforeRemove"
              :data="{fieldCode: 'BAWJ', fieldName: '考古发掘项目所在地的省级文物行政部门出具的意见'}"
              :file-list="form.swwjyj"
              :multiple="false"
              :limit="1"
              :before-upload="beforeUpload"
              :on-remove="(file,fileList)=>{return handleRemove (file,fileList,'swwjyj')}"
              :on-success="(file,fileList)=>{return fileUploadSuccess (file,fileList,'swwjyj')}"
              :on-error="fileUploadError"
            >
              <el-button size="small" type="primary">点击上传</el-button>
              <span slot="tip" class="el-upload__tip" style="font-size:12px">支持扩展名：doc / docx / pdf</span>
