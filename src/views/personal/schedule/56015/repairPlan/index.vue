<template>
  <div class="content">
    <el-card class="box-card" shadow="never">
      <div slot="header">馆藏一级文物修复方案申请</div>
    ...
    >
      <el-card shadow="never">
        ...
        <el-scrollbar :style="{height: dialogHeight-138+'px'}">
          <confirm-message type="repair" :key="Math.random()" :applyFormData="applyFormData" />
        </el-scrollbar>
      </el-card>
...
import ConfirmMessage from '@/components/business/ConfirmMessage56015/repairPlan'
