<template>
  <div class="content">
    <el-card class="box-card" shadow="never">
      <div slot="header">馆藏一级文物拓印方案申请</div>
    ...
    >
      <el-card shadow="never">
        <div slot="header">馆藏一级文物拓印方案申请确认</div>
        <el-scrollbar :style="{height: dialogHeight-138+'px'}">
          <confirm-message type="rubbings" :key="Math.random()" :applyFormData="applyFormData" />
        </el-scrollbar>
      </el-card>
...
import ConfirmMessage from '@/components/business/ConfirmMessage56015/rubbingsPlan'
