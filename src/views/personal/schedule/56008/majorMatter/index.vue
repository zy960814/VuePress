<template>
  <div class="content">
    <el-card class="box-card" shadow="never">
      <div slot="header">考古发掘计划（重大事项）申请</div>
...
import ConfirmMessage from '@/components/business/ConfirmMessage56008/majorMatter'
...
export default {
  ...
  methods: {
    ...
    saveOrSubmit(type) {
      ...
      // if (this.$refs.projectInformation.$refs.basicMessage) {
      //   console.log('basicMessage')
      //   Promise.all([
      //     this.$refs.applicantInformation.getFormData(type),
      //     this.$refs.applydocumentInformation.getFormData(type),
      //     this.$refs.projectInformation.$refs.basicMessage.getFormData(type),
      //     this.$refs.applyMaterial.getFormData(type)
      //   ]).then(val => {
      //     let form = Object.assign(...val)
      //     delete form['applyDocumentNum_part1']
      //     delete form['applyDocumentNum_part2']
      //     delete form['applyDocumentNum_part3']
      //     if (type === 'save') {
      //       console.log(type)
      //       // 下面调用接口--------
      //     } else if (type === 'submit') {
      //       this.applyFormData = form
      //       this.dialogVisible = true
      //     }
      //     // 下面调用接口--------
      //   })
      // } else if (this.$refs.projectInformation.$refs.textFact) {
      //   console.log('textFact')
      //   Promise.all([
      //     this.$refs.applicantInformation.getFormData(type),
      //     this.$refs.applydocumentInformation.getFormData(type),
      //     this.$refs.projectInformation.$refs.textFact.getFormData(type),
      ...
      //     }
      //   })
      // } else if (this.$refs.projectInformation.$refs.drawingFact) {
      //   console.log('drawingFact')
      //   Promise.all([
      //     this.$refs.applicantInformation.getFormData(type),
      //     this.$refs.applydocumentInformation.getFormData(type),
      //     this.$refs.projectInformation.$refs.drawingFact.getFormData(type),
      ...
      //     }
      //   })
      // } else if (this.$refs.projectInformation.$refs.explainFact) {
      //   console.log('explainFact')
      //   Promise.all([
      //     this.$refs.applicantInformation.getFormData(type),
      //     this.$refs.applydocumentInformation.getFormData(type),
      //     this.$refs.projectInformation.$refs.explainFact.getFormData(type),
      ...
      //     }
      //   })
      // } else if (this.$refs.projectInformation.$refs.materialFact) {
      //   console.log('materialFact')
      //   Promise.all([
      //     this.$refs.applicantInformation.getFormData(type),
      //     this.$refs.applydocumentInformation.getFormData(type),
      //     this.$refs.projectInformation.$refs.materialFact.getFormData(type),
    ...
    // getVal(type) {
    //   let applicantInformation = this.$refs.applicantInformation.getFormData(
    //     type
    //   )
    //   let applydocumentInformation = this.$refs.applydocumentInformation.getFormData(
    //     type
    //   )
    //   if (this.$refs.projectInformation.$refs.basicMessage) {
    //     var basicMessage = this.$refs.projectInformation.$refs.basicMessage.getFormData(
    //       type
    //     )
    //   }
    //   if (this.$refs.projectInformation.$refs.textFact) {
    //     var textFact = this.$refs.projectInformation.$refs.textFact.getFormData(
    //       type
    //     )
    //   }
    //   if (this.$refs.projectInformation.$refs.drawingFact) {
    //     var drawingFact = this.$refs.projectInformation.$refs.drawingFact.getFormData(
    //       type
    //     )
    //   }
    //   if (this.$refs.projectInformation.$refs.explainFact) {
    //     var explainFact = this.$refs.projectInformation.$refs.explainFact.getFormData(
    //       type
    //     )
    //   }
    //   if (this.$refs.projectInformation.$refs.materialFact) {
    //     var materialFact = this.$refs.projectInformation.$refs.materialFact.getFormData(
    //       type
    //     )
    //   }
    //   let applyMaterial = this.$refs.applyMaterial.getFormData(type)
    //   console.log(applicantInformation)

    //   let form = [
    //     ...applicantInformation,
    //     ...applydocumentInformation,
    //     ...basicMessage,
    //     ...textFact,
    //     ...drawingFact,
    //     ...explainFact,
