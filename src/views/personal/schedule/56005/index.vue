<template>
  <div class="content">
    <el-card class="box-card" shadow="never">
      <div slot="header">省级和全国重点文物保护单位保护范围内其他建设工程或者爆破、钻探、挖掘等作业申请</div>
...
import ConfirmMessage from '@/components/business/ConfirmMessage56005'
...
export default {
  ...
  methods: {
    ...
    saveOrSubmit(type) {
      ...
      //     // 下面调用接口--------
      //   })
      // } else if (this.$refs.projectInformation.$refs.projectSituation) {
      //   console.log('projectSituation')
      //   Promise.all([
      //     this.$refs.applicantInformation.getFormData(type),
      //     this.$refs.applydocumentInformation.getFormData(type),
      //     this.$refs.projectInformation.$refs.projectSituation.getFormData(
