        ...
        <template #body>
          ...
          <div class="scrollBox" :style="{height: contentHeight}">
            ...
            <!-- <relic-information
              ...
              id="relicInformation"
            ></relic-information>-->
            <relic-info class="hxl_item" ref="relicInfo" />
            <sampling-information
              applyType="56019"
              class="hxl_item"
              ref="samplingInformation"
              id="samplingInformation"
            ></sampling-information>
            <apply-material
              applyType="56019"
              class="hxl_item"
...
import RelicInfo from '@/views/personal/schedule/AddRelic/RelicInfo'
import SamplingInformation from './SamplingInformation'
import ApplyMaterial from './ApplyMaterial'
import ConfirmMessage from '@/components/business/ConfirmMessage56019'
  ...
  methods: {
    ...
    saveOrSubmit(type) {
      Promise.all([
        ...
        this.$refs.relicInfo.getFormData(type),
        this.$refs.samplingInformation.getFormData(type),
