<template>
  <apply-form-item data="申请材料">
    ...
    >
      <el-row>
        <el-col :span="24">
          <el-form-item ref="fileUpload" label="取样方案" prop="palnDesign" class="redStar normal">
            <el-upload
              :action="fileUploadUrl"
              :on-preview="handlePreview"
              :before-remove="beforeRemove"
              :data="{fieldCode: 'BAWJ', fieldName: '取样方案'}"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item ref="fileUpload" label="文物图片" prop="proxyStatement" class="redStar normal">
            <el-upload
              :action="fileUploadUrl"
              :on-preview="handlePreview"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item ref="fileUpload" label="其他" prop="taskStatement" class="normal">
            <el-upload
              :action="fileUploadUrl"
              :on-preview="handlePreview"
              :before-remove="beforeRemove"
