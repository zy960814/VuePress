<template>
  <div>
    <el-form
			...
			<el-row>
				<el-col :span="24">
					<el-form-item ref="fileUpload" label="资质申请表签字盖章扫描件" prop="technologyDocument" class="redStar">
						<el-upload
							:action="fileUploadUrl"
							:on-preview="handlePreview"
							:before-remove="beforeRemove"
							:data="{fieldCode: 'BAWJ', fieldName: '资质申请表签字盖章扫描件'}"
			...
			<el-row>
				<el-col :span="24">
					<el-form-item ref="fileUpload" label="法定代表人任职文件加盖公章彩色扫描件" prop="technologyDocument0" class="redStar">
						<el-upload
							:action="fileUploadUrl"
							:on-preview="handlePreview"
							:before-remove="beforeRemove"
							:data="{fieldCode: 'BAWJ', fieldName: '法定代表人任职文件加盖公章彩色扫描件'}"
