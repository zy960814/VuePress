...
<script>
  ...
  import BasicInfo from '@/views/personal/schedule/56020/temp-exit/exhibition-apply/BasicInfo'
  import ExhibitionInfo from '@/views/personal/schedule/56020/temp-exit/exhibition-apply/ExhibitionInfo'
  import CulturalRelicInfo from '@/components/business/CulturalRelicInfo'
  import {saveExhibitionInfo, listCulturalRelic} from '@/api/personal/schedule/56020/temp-exit'
  import MyDialog from '@/components/commons/MyDialog'
  import BusinessGuide from '@/views/personal/schedule/56020/temp-entry/exhibition-apply/BusinessGuide'
  import {getApplyDeDetail} from '@/api/appraisal/temp-exit'
  ...
  export default {
    ...
    mounted() {
      ...
      // 临时出境展览事项查询
      getApplyDeDetail({itemId}).then(({data}) => {
        // 文件回显, 数据适配
