...
<script>
  ...
  import {queryApplyDList, registerAll, branch} from '@/api/appraisal/temp-exit'
  ...
  export default {
    ...
    methods: {
      ...
      // 修改
      modify(row) {
        const path = `/appraisal/temp-exit/register/modify/exhibition-apply?id=${row.id}`;
