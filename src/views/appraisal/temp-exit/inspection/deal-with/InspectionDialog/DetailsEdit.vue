...
<script>
  ...
  import {fetchCulturalRelic} from '@/api/personal/schedule/56020/temp-exit'
  import CommonLanguage from '@/components/commons/CommonLanguage'
  import {inspection} from '@/api/appraisal/temp-exit'
  import {getAncestorAttr} from '@/utils/common'
  import {getBizCroAppraiseOpinion} from '@/api/appraisal/temp-exit'
