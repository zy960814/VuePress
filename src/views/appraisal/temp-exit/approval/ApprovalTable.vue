...
<script>
  ...
  import {queryApplyDList, againBranch, tieUp} from '@/api/appraisal/temp-exit'
  ...
  export default {
    ...
    methods: {
      ...
      // 办理
      handle(row) {
        const path = `/appraisal/temp-exit/approval/deal-with?id=${row.id}`;
