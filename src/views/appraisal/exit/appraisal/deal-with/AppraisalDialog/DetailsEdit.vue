    ...
    <div class="underContent">
      ...
      <el-form ref="cyForm" :model="cyForm" :rules="rules" label-width="120px" label-position="left">
        <div class="inspection_opinion">
          <div class="clear-float">
            <el-form-item label="是否是文物" prop="approvalFlag" class="half-width fl redStar">
              <el-radio v-model="cyForm.isCr" label="0">是</el-radio>
              <el-radio v-model="cyForm.isCr" label="1">否</el-radio>
            </el-form-item>
            <el-form-item label="是否允许出境" prop="approvalFlag" class="half-width fr redStar">
