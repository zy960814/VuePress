...
<script>
  ...
  import {queryApplyEList, registerAll, branch} from '@/api/appraisal/repeat-entry'
  ...
  export default {
    ...
    methods: {
      ...
      // 修改
      modify(row) {
        const path = `/appraisal/repeat-entry/register/modify/exhibition-apply?id=${row.id}`;
