...
<script>
  ...
  import {listCulturalRelic, delCulturalRelic, getBizCroCrPics} from '@/api/personal/schedule/56020/temp-exit'
  ...
  import {saveAgainEBizCroCr} from '@/api/personal/schedule/56020/repeat-entry'
  ...
  export default {
    ...
    computed: {
      // 临时出境事项 ID
      x_itemId: function () {
        return getAncestorAttr(this, 'x_itemId')
      },
      // 添加按钮是否可以点击
      addBtnEnabled: function () {
        // return true
        return this.x_itemId != null
      },
      // 弹出框
