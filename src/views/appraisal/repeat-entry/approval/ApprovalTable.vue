...
<script>
  ...
  import {queryApplyEList, againBranch, tieUp} from '@/api/appraisal/repeat-entry'
  ...
  export default {
    ...
    methods: {
      ...
      // 办理
      handle(row) {
        const path =`/appraisal/repeat-entry/approval/deal-with?id=${row.id}`;
