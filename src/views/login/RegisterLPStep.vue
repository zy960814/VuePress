    ...
    <div class="form">
      ...
      <nav>
        <el-form ref="form" :model="form" label-position="left" :rules="rules" label-width="100px">
            ...
            <el-col :span="11">
              <el-form-item label="账号密码" prop="applyPerson" class="redStar">
                <el-input
                  ...
                  placeholder="6~16位字符、至少包含数字、字母(区分大小写)及特殊字符中两种组合"
                ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col>
              <el-form-item ref="fileUpload" label="营业执照" prop="applyDocument1" class="redStar">
                <h4
                  class="formText"
                >提示：企业法人营业执照副本复印件(或事业单位主管机关颁发的单位法人证书或文件的复印件) 支持扩展名：.jpg .png .bmp</h4>
                <picture-upload
                  ref="imgUpload"
          ...
          <el-row>
            <el-col :span="11">
              <el-form-item label="联系方式" class="redStar" prop="lineChose">
                <el-row>
                  <el-col :span="9">
      ...
      <footer class="footer">
        <div style="height:45px;">
          <el-checkbox v-model="form.checked">
            <p>
              我已阅读并同意
              <span @click="toBps">《注册协议和隐私条款》</span>
            </p>
          </el-checkbox>
...
export default {
  ...
  computed: {
    ...
    dialogHeight: function() {
      return this.$store.getters.screenHeight > 530
        ? 530
