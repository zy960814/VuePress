<template>
  <div>
      ...
      <el-collapse-item title="工程级别填写说明" name="1">
        ...
        <table cellspacing="0" cellpadding="0" class="tableBox">
          <tr>
            ...
            <td colspan="18">
              <p class="textLeft">全国重点文物保护单位和国家文物局指定的重点文物的修缮工程、迁移工程、重建工程。</p>
            </td>
          </tr>
          <tr>
            <td colspan="1" class="text">二级</td>
            <td colspan="18">
              <p class="textLeft" >1.全国重点文物保护单位的保养维护工程、抢险加固工程。</p>
              <p class="textLeft" >2.省级文物保护单位的修缮工程、迁移工程、重建工程。</p>
          ...
          <tr>
            ...
            <td colspan="18">
              <p class="textLeft">1.省级文物保护单位的保养维护工程、抢险加固工程。</p>
              <p class="textLeft">2.市、县级文物保护单位和尚未核定公布为文物保护单位的不可移动文物的维护工程、抢险加固工程、修缮工程。</p>
            </td>
          </tr>
        </table>
      </el-collapse-item>
    ...
    <el-form
      ...
      <el-row>
        <el-col :span="11">
          <el-form-item label="开工许可时间" prop="startTime" class="redStar">
            <el-date-picker
      ...
      <el-row class="box">
        <el-col :span="11">
          <el-form-item label="验收日期" prop="finishTime" class="redStar"> 
            <el-date-picker
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item ref="fileUpload"  label-width="310px" label="项目批复文件扫描件(含立项、方案批复及核准函)" prop="technologyDocument" class="redStar">
            <el-upload
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item ref="fileUpload"  label-width="310px" label="项目合同及中标通知书（如有）扫描件并加盖公章" prop="technologyDocument" class="redStar">
            <el-upload
              :action="fileUploadUrl"
              :on-preview="handlePreview"
              :before-remove="beforeRemove"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item ref="fileUpload"  label-width="310px" label="项目开工文件扫描件并加盖公章" prop="technologyDocument1" class="redStar">
            <el-upload
              :action="fileUploadUrl"
              :on-preview="handlePreview"
              :before-remove="beforeRemove"
              :data="{fieldCode: 'BAWJ', fieldName: '项目开工文件扫描件并加盖公章'}"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item ref="fileUpload"  label-width="310px" label="项目验收文件扫描件并加盖公章（以省级文物行政部门或受省级文物行政部门委托的专业单位提交的盖章验收材料为准，由受委托单位验收的，需提供省级文物行政部门的委托函）" prop="technologyDocument2" class="redStar">
            <el-upload
              :action="fileUploadUrl"
              :on-preview="handlePreview"
              :before-remove="beforeRemove"
              :data="{fieldCode: 'BAWJ', fieldName: '项目验收文件扫描件并加盖公章（以省级文物行政部门或受省级文物行政部门委托的专业单位提交的盖章验收材料为准，由受委托单位验收的，需提供省级文物行政部门的委托函）'}"
