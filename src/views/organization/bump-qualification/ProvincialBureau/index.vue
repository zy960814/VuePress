<template>
	<div  class="content">
      ...
      :show-message="false">
			<el-row>
        <el-col :span="24">
          <el-form-item label="省局意见" prop="opinionContent" class="redStar">
            <el-input
              type="textarea"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="是否有违法或安全质量事故信息">
            <el-radio label="0" v-model="form.isIllegal">否</el-radio>
            <el-radio label="1" v-model="form.isIllegal">是</el-radio>
          </el-form-item>
        </el-col>
      </el-row>
      <div v-if="form.isIllegal === '1'">
        <el-row>
          <el-col :span="24">
            <el-form-item label="违法或安全质量事故信息" prop="economicType" class="redStar">
                <el-input v-model="form.economicType"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
      ...
      <el-row>
        <el-col :span="11">
          <el-form-item label="省局联系人" prop="economicPeople">
              <el-input v-model="form.economicPeople"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11" :offset="2">
          <el-form-item label="联系电话" prop="economicPeoplePhone" >
              <el-input v-model="form.economicPeoplePhone" ></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
