  ...
  <div class="waitHandle">
    ...
    <el-table :data="tableData" border stripe :height="contentHeight">
      ...
      <el-table-column label="操作" min-width="220" fixed="right">
        <template>
          <el-button type="primary" plain size="mini" @click = "findWorkOrder">修改</el-button>
          <el-button type="primary" plain size="mini" @click = "findWorkOrder">查看</el-button>
          <el-button type="primary" plain size="mini" @click = "findWorkOrder">撤回</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
export default {
  ...
  methods: {
    ...
    add() {
       this.$router.push(`/organization/bump-qualification`)
    },
    itemClick(evt) {
      switch (evt) {
        case 'set-up':
