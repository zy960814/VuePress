<template>
	<div  class="content">
      ...
      ref="form"
      :rules="rules"
      :model="allData.ChinaAssociation.form"
      label-position="left"
      label-width="130px"
      :show-message="false">
			<el-row>
        <el-col :span="24">
          <el-form-item label="意见"  prop="opinionContent" class="redStar">
            <el-input
              type="textarea"
              :autosize="{ minRows: 5}"
              v-model="allData.ChinaAssociation.form.opinionContent">
            </el-input>
          </el-form-item>
        </el-col>
			</el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item label="是否通过">
            <el-radio-group v-model="allData.ChinaAssociation.form.isIllegal">
        ...
        <el-col :span="24">
          <el-form-item ref="fileUpload" label="附件" prop="technologyDocument" >
            <el-upload
              ...
              :file-list="allData.ChinaAssociation.form.technologyDocument"
              :multiple="false"
              :limit="1"
       ...
       <el-row>
        <el-col :span="24">
          <el-form-item label="备注" prop="remark">
              <el-input type="textarea" :autosize="{ minRows: 3}" v-model="allData.ChinaAssociation.form.remark"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
		</el-form>
     <div v-else>
       <vertical-table
        style="width:100%;"
        :verticalTableData="allData.ChinaAssociation.form"
