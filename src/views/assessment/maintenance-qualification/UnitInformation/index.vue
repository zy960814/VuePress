<template>
  <div class="waitHandle">
        ...
        <el-form ref="form" :model="form" label-width="80px" label-position=left>
          <el-form-item label="资格类型">
            <el-checkbox-group v-model="checkList">
              <el-checkbox label="勘察设计甲级"></el-checkbox>
              <el-checkbox label="勘察设计乙级"></el-checkbox>
              <el-checkbox label="勘察设计丙级"></el-checkbox>
              <el-checkbox label="施工一级" ></el-checkbox>
              <el-checkbox label="施工二级" ></el-checkbox>
              <el-checkbox label="施工三级" ></el-checkbox>
              <el-checkbox label="监理甲级" ></el-checkbox>
              <el-checkbox label="监理乙级" ></el-checkbox>
              <el-checkbox label="监理丙级" ></el-checkbox>
            </el-checkbox-group>
          </el-form-item>
    ...
    <el-table
      ...
      <el-table-column width="120" label="单位名称" porp="organizationName">
        <template slot-scope="scope">{{ scope.row.organizationName }}</template>
      </el-table-column>
      <el-table-column min-width="100" prop="districtCode" label="省份"></el-table-column>
      <el-table-column min-width="100"  label="资质信息">
        <el-table-column min-width="100" prop="province" label="设计"> </el-table-column>
        <el-table-column min-width="100" prop="province" label="施工"> </el-table-column>
        <el-table-column min-width="100" prop="province" label="监理"> </el-table-column>
      </el-table-column>
      <el-table-column min-width="100" prop="name" label="法定代表人"></el-table-column>
      <el-table-column min-width="160" prop="address" label="地址"></el-table-column>
      <el-table-column min-width="100" prop="registeredCapital" label="注册资金(万元)"></el-table-column>
      <el-table-column min-width="160" prop="organizationNature" label="单位性质"></el-table-column>
...
export default {
  ...
  computed: {
    ...
    contentHeight: function() {
      return (
        'calc(100vh - ' + ((this.$store.getters.menuStyle === 1 ? 410 : 300) + this.collapseFormHeigth) + 'px)'
      )
    },
  },
  watch: {
  ...
  methods: {
    ...
    toggle(val) {  // 切换展开、收起
      this.collapseFormHeigth = val ? 0 : -111;
    },
    itemClick(evt) {
      switch (evt) {
        case 'set-up':
