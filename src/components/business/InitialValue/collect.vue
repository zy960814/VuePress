  ...
  data() {
    return {
      ...
      columns: [
        ...
        { label: '收藏单位名称', data: 'legalRepresentative', width: '100' },
        { label: '性质', data: 'districtCode', width: '150' },
        { label: '质量等级', data: 'address', width: '230' },
        { label: '藏品数(件/套)', data: 'zipCode', width: '150' },
        { label: '珍贵文物(件/套)', data: 'telNo', width: '150' },
        { label: '展览(个)', data: 'batchNum', width: '150' },
        { label: '教育活动(次)', data: 'zipCode', width: '150' },
        { label: '参观人数(万人次)', data: 'telNo', width: '150' },
      ],
      tableData: [
        {
