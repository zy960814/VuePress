...
export default {
  ...
  data() {
    return {
      ...
      tableData1: [],
      columns: [
        { label: '分类号', data: 'organizationName', width: '150' },
        { label: '名称', data: 'legalRepresentative', width: '100' },
        { label: '类型', data: 'districtCode', width: '150' },
        { label: '时代', data: 'address', width: '230' },
        { label: '地址', data: 'zipCode', width: '150' },
        { label: '批次', data: 'telNo', width: '150' },
