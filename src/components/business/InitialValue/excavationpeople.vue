      ...
      <collapse-form @search-fun="searchFun" @reset-form="resetForm" :collapse-enabled="false">
        <div slot="header" class="fl">
          <el-select v-model="value" style="float:left;margin-right:10px;">
            ...
            <el-option label="人员编号" value="keyWord1"></el-option>
            <el-option label="姓名" value="name"></el-option>
            <el-option label="所在单位" value="name"></el-option>
          </el-select>
          <div class="row_1 clear-float">
            <el-input
              placeholder="人员编号/姓名/所在单位"
...
export default {
  ...
  data() {
    return {
      ...
      tableData1: [],
      columns: [
        { label: '人员编号', data: 'organizationName', 'min-width': '150' },
        { label: '姓名', data: 'legalRepresentative', 'min-width': '100' },
        { label: '性别', data: 'districtCode', 'min-width': '150' },
        { label: '所在单位', data: 'address', 'min-width': '230' },
        { label: '省份', data: 'zipCode', 'min-width': '150' },
        { label: '学术专长', data: 'telNo', 'min-width': '150' },
      ],
      tableData: [
        {
