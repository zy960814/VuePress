      ...
      <collapse-form @search-fun="searchFun" @reset-form="resetForm" :collapse-enabled="false">
        <div slot="header" class="fl">
          <el-select v-model="value" style="float:left;margin-right:10px;">
            ...
            <el-option label="机构名称" value="keyWord1"></el-option>
            <el-option label="法定代表人" value="name"></el-option>
            <el-option label="地址" value="name"></el-option>
          </el-select>
...
export default {
  ...
  data() {
    return {
      ...
      tableData1: [],
      columns: [
        { label: '机构名称', data: 'organizationName', width: '150' },
        { label: '法定代表人', data: 'legalRepresentative', width: '100' },
        { label: '省份', data: 'districtCode', width: '150' },
        { label: '地址', data: 'address', width: '230' },
        { label: '邮编', data: 'zipCode', width: '150' },
        { label: '电话', data: 'telNo', width: '150' },
        { label: '批次', data: 'batchNum', width: '150' }
      ],
      tableData: [
        {
