      ...
      <collapse-form @search-fun="searchFun" @reset-form="resetForm" :collapse-enabled="false">
        <div slot="header" class="fl">
          ...
          <div class="row_1 clear-float">
            <el-input
              placeholder="请输入藏品名称/普查登记号/收藏单位"
...
export default {
  ...
  data() {
    return {
      ...
      tableData1: [],
      columns: [
        { label: '单位编号', data: 'organizationName', 'min-width': '150' },
        { label: '单位名称', data: 'legalRepresentative', 'min-width': '100' },
        { label: '法人代表', data: 'districtCode', 'min-width': '150' },
        { label: '省份', data: 'address', 'min-width': '230' },
        { label: '单位地址', data: 'zipCode', 'min-width': '150' },
        { label: '主管单位', data: 'telNo', 'min-width': '150' },
        { label: '邮政编码', data: 'districtCode', 'min-width': '150' },
        { label: '电话/传真', data: 'address', 'min-width': '230' },
      ],
      tableData: [
        {
