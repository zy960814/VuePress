<template>
    <div>
        <el-row v-if="showText" style="height: calc(100vh - 200px);overflow:auto">
        <table  class="tablesty" style="border-collapse: collapse" border="1px" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="detailboldfont-1" colspan="3"> 123</td>
                                <td class="detailboldfont" colspan="1">姓名</td>
                ...
                <tr>
                    <td class="detailboldfont" colspan="1">所在单位</td>
                    <td class="detailboldfont-1" colspan="9"> 123</td>
                </tr>
                <tr>
                    <td class="detailboldfont" colspan="1">地址或房间号</td>
                    <td class="detailboldfont-1" colspan="9"> 123</td>
                </tr>
                <tr>
        ...
        <el-row v-if="!showText">
                ...
                margin: 0 10px;margin-top: 10px;" label-position="left" label-width="110px" class="demo-ruleForm">
                <el-row>
                    <el-col :span="12">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="地址或房间号" prop="name">
                            <el-input v-model="ruleForm.name"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
