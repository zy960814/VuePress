<template>
  <div class="box">
    <apply-form-item data="原址保护措施专家评审意见表">
      <el-form
      ref="form"
      :rules="rules"
      :model="form"
      ...
      <div v-if="this.form.radio == 1"> 
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="相关资料图纸" prop="datumPaper">
              <el-input v-model="form.datumPaper" placeholder></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item label="设计说明" prop="explain" class="redStar">
