  ...
  <div class="ReplayDialog">
    ...
    >
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item label="方案编制人" prop="chargePerson" class="redStar">
      ...
      <template v-if="showSelect">
        <el-row class="qualityLine">
          <el-col :span="11">
            <el-form-item label="专业资格类型" prop="chargeQualityType" style="margin-bottom:0px;">
              <el-input v-model="form.chargeQualityType" :disabled="chargepersonDocumentDisabled"></el-input>
              <!-- <el-select
          ...
          <el-col :span="11" :offset="2">
            <el-form-item label="专业证书编号" prop="qualityNum" style="margin-bottom:0px;">
              <el-input v-model="form.qualityNum" :disabled="chargepersonDocumentDisabled"></el-input>
              <!-- <el-select
...
import PersonalOrganizationDocument from '@/components/business/PersonalOrganizationDocument'
export default {
  name: 'ChargepersonDialog',
  components: {
    MyDialog,
    PersonalOrganizationDocument
  },
  data() {
    return {
      dialogVisible: false,
