    ...
    <el-scrollbar :style="{height: height}">
      ...
      <apply-form-item data="项目信息">
        ...
        <vertical-table
          ...
          borderTitle="none"
          :verticalTableData="applyFormDataInner"
          :verticalTableTitle="textFactTitle"
          width="150px"
        ></vertical-table>
        <vertical-table
          title="图纸概况"
          ...
          borderTitle="none"
          :verticalTableData="applyFormDataInner"
          :verticalTableTitle="drawingFactTitle"
          width="150px"
        ></vertical-table>
        <vertical-table
          title="说明概况"
          ...
          borderTitle="none"
          :verticalTableData="applyFormDataInner"
          :verticalTableTitle="explainFactTitle"
          width="150px"
        ></vertical-table>
        <vertical-table
          title="基础资料汇编概况"
          ...
          borderTitle="none"
          :verticalTableData="applyFormDataInner"
          :verticalTableTitle="materialFactTitle"
          width="150px"
        ></vertical-table>
      </apply-form-item>
      <apply-form-item data="申请材料">
        <vertical-table
          ...
          borderTitle="none"
          :verticalTableData="applyFormDataInner"
          :verticalTableTitle="applyType==='applyMaterialTitle_08'?applyMaterialTitle_08:applyMaterialTitle_09"
          width="150px"
        >
...
export default {
  ...
  data() {
    return {
      ...
      // 基本信息
      basicMessageTitle: [
        { nationalSecurityName: '文物保护单位名称', province: '省份 ' },
        { relicCategory: '文物类型' },
        { projectName: '项目名称' },
      ...
      textFactTitle: [
        ...
        { protestObject: '保护对象' },
        { worthAsscess: '价值评估' },
        { principleTarget: '保护规划原则与目标' },
        { researchPlainning: '考古与科学研究规划' },
        { environmentRenovate: '环境整治规划' },
        { showRules: '展示规划' },
        { infrastructurePlanning: '基础设施规划' },
        { managerPlanning: '管理规划' },
        { periodizationPlanning: '分期规划' },
        { protectFunds: '保护实施经费' },
        { appendix: '附则' }
      ],
      // 图纸概况
      drawingFactTitle: [{ drawingDescribe: '保护规划图纸' }],
      // 说明概况
      explainFactTitle: [
        { reserveRules: '保护区划管理规定' },
        { remainderPlan: '遗址本体保护规划' },
        { archaeologyWithResearch: '考古与科学研究规划' },
        { showUseRulse: '展示利用规划' },
        { securityPlan: '安全防灾规划' },
        { remainderProtectWithdevelopment: '遗址保护与地方社会发展协调规划' },
        { protectPlan: '保护管理规划' }
      ],
      // 基础资料汇编概况
      materialFactTitle: [
        { chronicle: '大记事' },
        { protectRange: '原保护范围及建设控制地带情况' },
        { archaeologyInvestigate: '考古调查简报' },
        { researchDocument: '相关研究文献目录' }
      ],
      //申请材料_08
      applyMaterialTitle_08: [
        { archaeologyPlan: '中华人民共和国考古发掘申请书' },
        { suggestion: '相关省级文物行政部门意见' },
        { other: '其他' }
      ],
      //申请材料_09
      applyMaterialTitle_09: [
        { workPlan: '相关工作方案' },
        { suggestion: '相关省级文物行政部门意见' },
        { other: '其他' }
      ]
