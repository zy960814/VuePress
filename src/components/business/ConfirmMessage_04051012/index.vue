  ...
  <div class="content">
    ...
    <apply-form-item data="基本信息">
      <vertical-table
        ...
        :verticalTableTitle="basicInformationTitle_56005"
        width="150px"
        v-if="applyType==='56005'"
      >
        <template #line_30="scope">
          <span v-if="scope.colValue==='1'">是</span>
          <span v-if="scope.colValue==='2'">否</span>
          <span v-else>{{ }}</span>
        </template>
      ...
      <vertical-table
        style="width:100%;"
        :verticalTableData="applyFormData"
        :verticalTableTitle="basicInformationTitle_56010"
        width="150px"
        v-else-if="applyType==='56010'"
      >
      ...
      <vertical-table
        style="width:100%;"
        :verticalTableData="applyFormData"
        :verticalTableTitle="basicInformationTitle_other"
        width="150px"
        v-else
      >
        <template #line_20="scope">
    ...
    <!-- <apply-form-item data="申请文件信息">
          ...
          >
            <template #line_01="scope">
              <el-link type="primary">{{scope.colValue}}</el-link>
            </template>
          </vertical-table>
    </apply-form-item>-->
...
export default {
  ...
  data() {
    return {
      ...
      // applyDocumentTitle: [
      //   { applyDocumentNo: '申请文件号', descideOrganization: '决定机构 ' },
      //   { applyDocumentTitle: '申请文件标题', '': '' }
      // ],
      basicMessageTitle: [
        { projectName: '项目名称' },
      ...
      projectSituationTitle: [
        { projectSituationIntroduction: '工程概况说明' },
        { buildNecessary: '建设的必要性' },
        { compilationBasis: '编制依据' },
        { lineChose: '线路选择' },
        { technologyMeasure: '文物保护技术措施' },
        { emergencyMeasure: '文物保护应急措施' }
      ],
      applyMaterialTitle: [
        { technologyDocument: '技术文件' },
        { assessmentReport: '文物影响评估报告' },
        { protectPlan: '保护规划' },
        { relicReport: '考古勘探或发掘报告' },
        { other: '其他' }
      ]
      // applyFormData: {
  ...
  computed: {
    ...
    //   let basicInformationTitle = []
    //   if (this.applyType === '56005') {
    //     basicInformationTitle = this.basicInformationTitle_56005
    //   } else {
    //     basicInformationTitle = this.basicInformationTitle_other
    //   }
    //   return basicInformationTitle
    // }
  },
  watch: {},
  created() {},
